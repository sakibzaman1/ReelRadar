          ...
          >
            <form onSubmit={handleSignIn} className="card-body mt-10 lg:mt-0">
              ...
              <div className="form-control mt-10">
                <button className="h-14 hover:scale-110 transition-transform font-semibold w-full bg-gradient-to-r from-sky-950 via-sky-700 to-sjy-200 text-white">
                  Sign in
                </button>
              </div>
              ...
              <div className="flex flex-col justify-between mt-10 mb-6 space-y-6 lg:space-y-0">
                <button
                  ...
                  className="text-white btn rounded-none bg-transparent hover:rounded-none capitalize"
                >
                  <FcGoogle></FcGoogle>
                  Sign in with Google
                </button>
