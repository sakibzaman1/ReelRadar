                    ...
                    <div className="card lg:w-[60%] flex-shrink-0 max-w-lg shadow-2xl ">
                        ...
                        <h1 className="text-5xl font-bold text-center mb-10">Sign in now!</h1>
                            ...
                            <div className="form-control mt-10">
                                <button className="h-14 hover:scale-110 transition-transform font-semibold w-full bg-gradient-to-r from-sky-950 via-sky-700 to-sjy-200 text-white">Sign in</button>
                            </div>

                            <div className="flex flex-col justify-between mt-10 mb-6 space-y-6 lg:space-y-0">
                                <button onClick={handleGoogleSignIn} className="text-white btn rounded-none bg-transparent hover:rounded-none capitalize">
                                    <FcGoogle></FcGoogle>
                                    Sign in with Google
                                </button>
                            </div>
                            ...
                            <div className="text-center pt-6">
                                <small className="font-medium text-white">New to this Website? Please<Link to="/register" className="text-red-700 ml-1"><button onClick={goToTop}>Register</button></Link></small>
                            </div>
                        </form>
                    </div>
                </div>
