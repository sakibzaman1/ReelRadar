...
const ManageUsers = () => {
  ...
  return (
    <div>
       <h1 className='mx-auto lg:text-xl mb-10 px-2 py-2 bg-gradient-to-r from-transparent via-sky-300 to-transparent text-black text-center w-60'>Manage Users</h1>
